...
elseif ($Type -eq "mi") {
    ...
    # Obtener token ARM del contexto actual para consultar permisos efectivos
    ...
    foreach ($entry in $miList) {
        ...
        # Permisos QUE TIENE el contexto actual (el usuario/SP autenticado) sobre cada recurso asociado
