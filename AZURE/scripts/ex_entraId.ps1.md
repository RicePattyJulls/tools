...
# =============================================================
# LOGICAPP — Invocar Logic App y extraer trigger URLs
# =============================================================
...
# =============================================================
# GROUPADD — Añadir miembro a un grupo
# =============================================================
...
# =============================================================
# UPDATEUSER — Actualizar atributo de un usuario
# =============================================================
...
# =============================================================
# GRAPHREAD — Leer OneDrive o buzón via Microsoft Graph
# =============================================================
elseif ($Type -eq "graphread") {
    ...
    if ($Mode -eq "onedrive") {
        Write-Host "`n[*] Enumerando OneDrive de: $Identity" -ForegroundColor Cyan
        try {
            ...
            # Descargar archivo si se especifica -FileName
            if ($FileName) {
                ...
                # La downloadUrl viene como propiedad directa del objeto REST
        ...
        if ($MessageId) {
            # Leer contenido de un mensaje especifico
            Write-Host "`n[*] Leyendo mensaje: $MessageId" -ForegroundColor Cyan
            try {
            ...
            # Listar top 20 mensajes
            Write-Host "`n[*] Listando mensajes de: $Identity" -ForegroundColor Cyan
            try {
...
# =============================================================
# JOBOUTPUT — Obtener output de un job de Azure Automation
# =============================================================
elseif ($Type -eq "graphread") {
...
# =============================================================
# RUNBOOKCONTENT — Descargar contenido de un runbook
# =============================================================
...
# =============================================================
# CHANGEPASS — Cambiar contraseña de un usuario
# =============================================================
elseif ($Type -eq "updateuser") {
...
# =============================================================
# PIMACTIVATE — Activar rol PIM eligible (selfActivate)
# =============================================================
elseif ($Type -eq "updateuser") {
    if (-not $Identity) { throw "[-] -Identity es obligatorio para -Type 'updateuser'." }
    if (-not $Property)  { throw "[-] -Property es obligatorio para -Type 'updateuser'." }
